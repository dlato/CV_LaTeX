...
\WorkEntry{PhD in Bioinformatics and Bacterial Genomic}{2015-Present}{McMaster University, Hamilton, ON}{
	\begin{itemize}
		...
		\item Familiarization with bioinformatics tools and testing procedures related to data visualization, summary tables, sequence annotation, molecular evolution, gene expression, and genome assembly.
		...
		\item Independently modified and developed precise documentation for bio-statistical testing and analytical processes using \texttt{R}, \texttt{R-shiny} interactive graphics and \texttt{Python}, resulting in a first author publication \cite{Lato:20}.
...
\end{itemize}}
%\WorkEntryE{Research Assistant}{2012-2014}
...
%		\end{itemize}}
%	\WorkEntryD{Surgical Oncology, University of Toronto, Toronto, ON}{2013}{
%		\begin{itemize}
%		\item Completed extensive clinical/health data and literature reviews in the surgical oncology field.
%		\end{itemize}}
%	\sloppy\WorkEntryD{Motherisk, The Hospital for Sick Children, Toronto, ON}{2012}{
%		\begin{itemize}

...
\WorkEntry{PhD in Bioinformatics and Bacterial Genomics}{Sep 2015 - Present}{McMaster University, Hamilton, ON}{
	\begin{itemize}
		...
		\item Independently designed and implemented experimental tools for bio-statistical testing and analytical processes using \texttt{R}, \texttt{R-shiny} interactive graphics and \texttt{Python}, resulting in two first author publications \cite{Lato:20,Lat:20}.

...
\EducationEntry{Doctor of Philosophy Candidate in Bioinformatics}{2015-Present}{McMaster University, Hamilton, ON}{%Supervisors: Professor G. Brian Golding\\
...
\WorkEntry{PhD in Bioinformatics and Bacterial Genomic}{2015-Present}{McMaster University, Hamilton, ON}{
	\begin{itemize}
		\item Development and innovative application of advanced simulation, data analysis, visual analytics and other computational techniques to research phenomenon in molecular evolution and bacterial genomics.
		\item Familiarization with bioinformatics tools and pipelines related to sequence annotation, phylogenetics, molecular evolution, gene expression, genome assembly, and data visualization.
		\item Considerable training in high performance computing and programming, data visualization, statistical analysis, big data storage, and software tool development.
		\item Independently odified and developed precise research methodology for bio-statistical analytic techniques using \texttt{R} and \texttt{Python}, resulting in a first author publication \cite{Lato:20}.
		\item Grant and paper writing knowledge and involvement.
		\item Collaborated with students, professors and other academics from the Anthropology, Health Sciences, Mathematics, and Statistics departments on completing projects related to infectious disease, ancient DNA, and molecular evolution in a timely manner. 
		\item Independently managed undergraduate student research projects by providing vision and direction regarding project objectives, task distribution resulting in a successful project.
...
\end{itemize}}
\WorkEntry{Research Assistant}{2014}{Biology, McMaster University, Hamilton, ON}{
	\begin{itemize}
...
\end{itemize}}
\WorkEntry{Research Assistant}{2013}{Surgical Oncology, University of Toronto, Toronto, ON}{
	\begin{itemize}
	\item Completed extensive clinical/health data and literature reviews in the surgical oncology field.
\end{itemize}}
\sloppy\WorkEntry{Research Assistant}{2012}{Motherisk, The Hospital for Sick Children, Toronto, ON}{
	\begin{itemize}
	\item Acquisition and analysis of clinical/health administrative data from patient medical charts, datasets, and surveys to determine the impacts of maternal genetic testing and adverse infant effects resulting in a publication \cite{More:17}.
...
\WorkEntryB{McMaster Synchronized Swimming Team}{2014-Present}{McMaster University, Hamilton}

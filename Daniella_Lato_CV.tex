...
\usepackage[left=2cm,top=1cm,right=2cm,bottom=3cm,nohead]{geometry}									% Saving trees ;-) 
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead{}
...
\WorkEntry{PhD in Bioinformatics and Bacterial Genomics}{Sep 2015 - Present}{McMaster University, Hamilton, ON}{
	\begin{itemize}
		...
		\item Create detailed documentation (SOP) on operating procedures for computational pipelines.
		...
		\item Independently designed and implemented experimental tools for bio-statistical testing and analytical processes using \texttt{R}, \texttt{R-shiny} interactive graphics and \texttt{Python}, resulting in a first author publication \cite{Lato:20}.
		\item Collaborated with students, professors and other academics from the Anthropology, Health Sciences, Mathematics, and Statistics departments on completing complex projects related to infectious disease, ancient DNA, and microbial evolution in a timely and reliable manner. 
		\item Managed undergraduate student research projects by providing vision and direction regarding working process, research, and task distribution resulting in a successful project.
		\item Concisely communicated scientific research to field specific and public audiences of up to 230 people at 4 international conferences, culminating in overwhelming positive oral presentation feedback.
		...
		\item Generated progress reports for funding agencies tracking research projects, cost and inventory of research materials, and summary of investigation resulting in renewal of grants.
\end{itemize}}
...
\WorkEntry{SNAP (Special Needs Assistance Program)}{Sep 2016 - Apr 2019}{McMaster University, Hamilton}{Assist community members who have cognitive and/or physical disabilities complete physical exercise by providing creative physical assistance, personalized workout plans, and emotional support which resulted in a 77\% increase in gross motor capabilities.}
...
\WorkEntryB{Tour Guide}{Apr 2017 - Present}{McMaster University, Hamilton}
...
\WorkEntryB{Teaching Assistant}{Sep 2014 - Present}{McMaster University, Hamilton}
...
\WorkEntryB{Guest Lecture: Molecular Evolution}{Mar 2018}{Department of Biology, McMaster University, Hamilton}
\WorkEntryB{Workshop Leader}{Mar 2017}{McMaster University, Hamilton}
